...
import com.historiaclinica.historiaclinica.service.HorarioAtencionService;
...
//    private RolRepository rolesRepository;
    ...
    @GetMapping("/horario-atencion/get-all")
    public ResponseEntity<List<HorarioAtencion>> getAllHorarioAtencion() {
        List<HorarioAtencion> horarioAtencion = horarioAtencionService.getAllHorarioAtencion();
